...
typedef enum keys {
    ...
    KEY_SELECT = 0x29,
    KEY_PRINT = 0x2A,
    // KEY_EXECUTE = 0x2B, // Commented out due to conflict with windows macro...
...
// Keyboard input
KEI_API bool8 kei_input_is_key_down(keys key);
KEI_API bool8 kei_input_is_key_up(keys key);
KEI_API bool8 kei_input_was_key_down(keys key);
KEI_API bool8 kei_input_was_key_up(keys key);

// Mouse input
KEI_API bool8 kei_input_is_button_down(buttons button);
KEI_API bool8 kei_input_is_button_up(buttons button);
KEI_API bool8 kei_input_was_button_down(buttons button);
KEI_API bool8 kei_input_was_button_up(buttons button);
KEI_API void kei_input_get_mouse_position(int32 *x, int32 *y);
KEI_API void kei_input_get_mouse_position_previous(int32 *x, int32 *y);
