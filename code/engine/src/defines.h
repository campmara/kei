...
#define KEI_PLATFORM_WINDOWS 1
#ifndef _WIN64
#error "64-bit is required on Windows!"
#endif
#elif defined(__linux__) || defined(__gnu_linux__)
// Linux OS
#define KEI_PLATFORM_LINUX 1
#if defined(__ANDROID__)
#define KEI_PLATFORM_ANDROID 1
#endif
#elif defined(__unix__)
// Catch anything not caught by the above.
#define KEI_PLATFORM_UNIX 1
#elif defined(_POSIX_VERSION)
// Posix
#define KEI_PLATFORM_POSIX 1
#elif __APPLE__
// Apple platforms
#define KEI_PLATFORM_APPLE 1
#include <TargetConditionals.h>
#if TARGET_IPHONE_SIMULATOR
// iOS Simulator
#define KEI_PLATFORM_IOS 1
#define KEI_PLATFORM_IOS_SIMULATOR 1
...
#else
#define KEI_API __attribute__((visibility("default")))
#endif
#else
// Imports
#ifdef _MSC_VER
